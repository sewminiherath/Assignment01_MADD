...
class RecommendedActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        dotActive.setOnClickListener {
            // Already on page 1, do nothing
        }

        dotInactive.setOnClickListener {
            val intent = Intent(this, Recommended2Activity::class.java)
            startActivity(intent)
            finish()
        }
        ...
        destination5Card.setOnClickListener {
            openWebsite("https://www.srilanka.travel/sigiriya")
        }
        
        destination6Card.setOnClickListener {
            openWebsite("https://www.srilanka.travel/galle")
        }
    }
